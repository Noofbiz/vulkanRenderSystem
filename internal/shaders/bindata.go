...
func vertSpv() (*asset, error) {
	...
	info := bindataFileInfo{name: "vert.spv", size: 1800, mode: os.FileMode(420), modTime: time.Unix(1585938058, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
